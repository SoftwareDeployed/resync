...
Every runtime module generated by `StoreBuilder.Local.Define`, `StoreBuilder.Synced.Define`, or `StoreBuilder.Synced.DefineCrud` conforms to the `StoreBuilder.Runtime.Exports` module type (`StoreBuilder.re:259-286`). The lifecycle surface is:
