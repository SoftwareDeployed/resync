DROP TABLE IF EXISTS _resync_actions_fail_server_mutation CASCADE;

DROP TABLE IF EXISTS _resync_actions_create_list CASCADE;

DROP TABLE IF EXISTS _resync_actions_add_todo CASCADE;

DROP TABLE IF EXISTS _resync_actions_set_todo_completed CASCADE;

DROP TABLE IF EXISTS _resync_actions_remove_todo CASCADE;

DROP TABLE IF EXISTS _resync_actions_rename_list CASCADE;
...
INSERT INTO schema_migrations (version) VALUES ("20260418015323") ON CONFLICT (version) DO NOTHING;
