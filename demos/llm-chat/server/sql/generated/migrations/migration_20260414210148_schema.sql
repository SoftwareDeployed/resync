...
CREATE TABLE IF NOT EXISTS _resync_actions (
...
BEGIN
  ...
  LOOP
    did_broadcast := TRUE;
    channel_name := parent_row_id::text;
...
INSERT INTO schema_migrations (version) VALUES ("20260414210148") ON CONFLICT (version) DO NOTHING;
